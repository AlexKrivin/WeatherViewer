...
// Главный класс Activity для приложения Weather Viewer.
...
import com.example.alex_k.weatherviewer.AddCityDialogFragment.DialogFinishedListener;
import com.example.alex_k.weatherviewer.CitiesFragment.CitiesListChangeListener;
...
{
    public static final String WIDGET_UPDATE_BROADCAST_ACTION = "com.example.alex_k.weatherviewer.UPDATE_WIDGET";
    ...
    public void onSaveInstanceState(Bundle savedInstanceStateBundle)
    {
        ...
        savedInstanceStateBundle.putString(LAST_SELECTED_KEY, lastSelectedCity); // save the currently selected city
    ...
    public void onRestoreInstanceState(Bundle savedInstanceStateBundle)
    {
        ...
        currentTab = savedInstanceStateBundle.getInt(CURRENT_TAB_KEY);lastSelectedCity = savedInstanceStateBundle.getString(LAST_SELECTED_KEY); // get the selected city
    ...
    public void selectForecast(String name)
    {
        ...
        if (currentForecastFragment == null || !(currentForecastFragment.getZipcode().equals(zipcodeString) && correctTab(currentForecastFragment)))
        {
            ...
            {
                // create a new ForecastFragment using the given zipcode
                currentForecastFragment = FiveDayForecastFragment.newInstance(zipcodeString);
            } // end else
    ...
    private void getCityNameFromZipcode(String zipcodeString, boolean preferred)
    {
        ...
        if (favoriteCitiesMap.containsValue(zipcodeString))
        {
            ...
            Toast errorToast = Toast.makeText(WeatherViewerActivity.this, WeatherViewerActivity.this.getResources().getString(R.string.duplicate_zipcode_error), Toast.LENGTH_LONG);
        ...
        else
        {
            ...
            new ReadLocationTask(zipcodeString, this, new CityNameLocationLoadedListener(zipcodeString, preferred)).execute();
        } // end else
    ...
    private class CityNameLocationLoadedListener implements LocationLoadedListener
    {
        ...
        public void onLocationLoaded(String cityString, String stateString, String countryString)
        {
            ...
            else
            {
                ...
                // not be found
                Toast zipcodeToast = Toast.makeText(WeatherViewerActivity.this, WeatherViewerActivity.this.getResources().getString(R.string.invalid_zipcode_error), Toast.LENGTH_LONG);
